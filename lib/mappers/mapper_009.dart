...
class Mapper009 extends Mapper {
  Mapper009(super.programBankCount, super.totalCharBanks) {
  ...
  void reset() {
    ...
    setPrgBank8k(0, _prgBank);
    setPrgBank8k(1, programBankCount * 2 - 3);
